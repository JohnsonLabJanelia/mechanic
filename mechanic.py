...
class TensorRTConverterGUI:
    ...
    def setup_gui(self):
        ...
        ttk.Label(main_frame, text="Output location:", font=small_bold_font).grid(row=10, column=0, sticky=tk.W, pady=5)
        ...
        ttk.Label(main_frame, text="Output file name:", font=small_bold_font).grid(row=11, column=0, sticky=tk.W, pady=5)
